...
- **Body** (400, 17px desktop / 16px mobile, 1.65): parágrafos; leads a 1.08rem com máx. 62ch; micro-escala exata: .8rem (rótulo do marquee, badge de etapa), .88rem (small), .9rem (tag sobre foto), .92rem (footer), .94rem (rótulo de stat), .95rem (corpo de card e figcaption), .97rem (checklist do rail), .98rem (etapas e lista B2B).
